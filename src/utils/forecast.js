...
const forecast = (longitude, latitude, callback) => {
    ...
    request({ url , json: true},(error, { body }) => {
        if(error){
            ...
            const msg = 'It is ' + body.current.weather_descriptions[0] + ' today. It is currently ' + body.current.temperature + ' degress out, but it feels like ' + body.current.feelslike + ' degrees outside.'
            callback(undefined, msg)
        }
    })
}
